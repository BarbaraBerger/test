...
if (!isset($_SESSION['mail'])) { //si ob ouvre le site sans être connecté, on accède à rien
...
?>
  <div class="alert alert-success">
    ...
    <form action="accueil.php" method="post">
		...
		<label for="contenu_post"></label><input type="text" class="form-control" id="contenu_post" name="contenu_post" aria-describedby="emailHelp" placeholder="Exprimez-vous sur ce lien" required/>
